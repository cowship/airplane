...
def plot_histogram(
    ...
    ax.set_title(f"{method_name}  —  Boarding Time Distribution  (n={len(ticks)})",
...
def plot_boxplot(
    ...
    data   = [all_results[n] * config.TICK_DURATION for n in names]
    ...
    ax.set_title("Boarding Methods Comparison", fontsize=14, fontweight="bold")
